...
function buildWhatsAppUrl(items: ReturnType<typeof useCartStore.getState>["items"]): string {
  ...
  const message = [
    "Hola! Quiero finalizar mi compra en CROWNLESS CULT:",
    "",
    ...lines,
    "",
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              <div className="flex items-center gap-2">
                ...
                {items.length > 0 && (
                  <span className="w-5 h-5 bg-black text-[#A5957F] text-[10px] font-bold rounded-full flex items-center justify-center">
              ...
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full gap-5 text-center">
                  ...
                  <Link
                    href="/collections"
                    onClick={closeCart}
                    className="text-[12px] font-[family-name:var(--font-montserrat)] font-black uppercase tracking-[0.2em] bg-black text-[#A5957F] px-6 py-3 hover:opacity-70 transition-opacity rounded-[3px]"
                  >
                    Ver Colección
                  </Link>
                </div>
            ...
            {items.length > 0 && (
              <div className="px-6 py-4 border-t border-gray-100 space-y-3">
                ...
                <a
                  ...
                  onClick={closeCart}
                  className="flex items-center justify-center gap-2 w-full bg-black text-[#A5957F] font-[family-name:var(--font-montserrat)] text-[13px] font-black uppercase tracking-[1.3px] h-[52px] rounded-[3px] hover:opacity-70 transition-opacity"
                >
